    ...
    },
    {
      ...
      games: [
        ...
        },
        {
          ...
          items: ['0.0077', 'BTC'],
          href: '/games/bigger-bass-bonanza-pragmatic-play',
        },
        {
          ...
          subTitle: 'Gold Vein',
          items: ['0.0087', 'BTC'],
          href: '/games/gold-vein-booming-games',
        },
        {
          ...
          items: ['0.0001', 'BTC'],
          href: '/games/power-of-gods-the-pantheon-wazdan',
        },
        {
        ...
        },
        {
          ...
          items: ['0.0001', 'BTC'],
          href: '/games/aztec-pyramids-mr-slotty',
        },
        {
          ...
          items: ['0.0001', 'BTC'],
          href: '/games/champions-of-rome-yggdrasil',
        },
      ],
    },
    {
  ...
  const loyaltyLevels = [
    {
      ...
      name: 'Previous',
      number: 1,
      image: '/img/uploads/achieve-1.png',
    ...
    },
    {
      ...
      name: 'Previous',
      number: 1,
      image: '/img/uploads/achieve-2.png',
      statusPointsLabel: 'Status points',
      statusPointsValue: '139 - 178',
      rankBonusLabel: 'Rank bonus',
      rankBonusValue: '-',
    ...
    },
    {
      ...
      name: 'Level Name',
      number: 2,
      image: '/img/uploads/achieve-3.png',
      statusPointsLabel: 'Status points',
      statusPointsValue: '-',
      rankBonusLabel: 'Rank bonus',
      rankBonusValue: '-',
    ...
    },
    {
      ...
      name: 'Level Name',
      number: 2,
      image: '/img/uploads/achieve-4.png',
      statusPointsLabel: 'Status points',
      statusPointsValue: '-',
      rankBonusLabel: 'Rank bonus',
      rankBonusValue: '5',
