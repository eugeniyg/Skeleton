...
<script setup lang="ts">
  ...
  const { getContentData: getPageContent } = useNewContentLogic<IProfileHistory>(pageContentParams);
  ...
  const { getContentData: getMenuContent } = useNewContentLogic<any>(menuContentParams);
