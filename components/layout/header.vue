      ...
      <div class="items">
        ...
        <client-only>
          <template v-if="isLoggedIn">
            ...
            <client-only>
              <notifications-popover-activator
                :count="fakeStore.items.notifications.length - 1"
                :is-active="isShowNotifications"
                @style="positionLeft = $event"
                @activate="showNotifications"
          ...
          <template v-else>
            ...
            >
              ...
              <span class="btn-primary__text">{{ getContent(layoutData, defaultLocaleLayoutData, 'header.registrationButton')
                }}</span>
            </button-base>
            ...
            >
              ...
              <span class="btn-secondary__text">{{ getContent(layoutData, defaultLocaleLayoutData, 'header.loginButton')
                }}</span>
            </button-base>
          </template>
        </client-only>
