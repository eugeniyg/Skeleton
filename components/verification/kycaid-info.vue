...
<script setup lang="ts">
  ...
  const infoList = computed(() => {
    return getContent(verificationContent.value, defaultLocaleVerificationContent.value, 'kycaid.infoList') || [];
  });
</script>

<style src="~/assets/styles/components/verification/kycaid-info.scss" lang="scss" />
